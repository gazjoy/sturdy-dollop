        ...
        <div class="u-container">
            ...
            <div class="grid g-gutter-x g-center">
                ...
                <div class="field-group g-col-lg-2">
                    <label class="field-group__label" for="select">Choose a park</label>
                ...
                <div class="field-group g-col-lg-2">
                    <label for="text" class="field-group__label">When</label>
                    <div class="field-group__field">
                        <input id="text" type="text" placeholder="Select a date">
                    </div>
                </div>
                    
                <div class="field-group g-col-lg-2">
                    <label class="field-group__label" for="select">Duration</label>
                    <div class="field-group__field">
                        <div class="select">
                ...
                <div class="field-group g-col-lg-2">
                    <label class="field-group__label" for="select">Accommodation</label>
                    <div class="field-group__field">
                        <div class="select">
                ...
                <div class="field-group g-col-lg-2">
                    <label for="text" class="field-group__label">Where are you?</label>
                    <div class="field-group__field">
                        <input id="text" type="text" placeholder="First 4 digits of postcode">
                    </div>
                </div>
